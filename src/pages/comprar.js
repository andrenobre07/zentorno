...
export default function Comprar() {
  ...
  const [carros, setCarros] = useState([
    {
      id: "carro1",
      nome: "Tesla Model S",
      descricao: "Elétrico de luxo com autonomia excepcional",
      preco: 85000,
      categoria: "eletrico",
      imagem: "/carro1.jpg"
    },
    {
      id: "carro2",
      nome: "BMW Serie 5",
      descricao: "Sedan de luxo com tecnologia de ponta",
      preco: 65000,
      categoria: "sedan",
      imagem: "/carro2.jpg"
    },
    {
      id: "carro3",
      nome: "Jeep Wrangler",
      descricao: "SUV off-road com design icônico",
      preco: 55000,
      categoria: "suv",
      imagem: "/carro3.jpg"
    }
  ...
  const [carrosFiltrados, setCarrosFiltrados] = useState(carros);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["todos", "eletrico", "sedan", "suv", "hatchback", "picape"].map((tipo) => (
                    <button
                      key={tipo}
